...
private ?int $nbrplacetottale = null;
...
public function getNbrplacetottale(): ?int
{
    return $this->nbrplacetottale;
}

public function setNbrplacetottale(int $nbrplacetottale): static
{
